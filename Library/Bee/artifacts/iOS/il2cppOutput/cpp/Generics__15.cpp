...
IL_0009:
	...
	try
	{
		...
		try
		{
			RuntimeObject* L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_Add_mD455094771BC3694A38416DA70E16A5B6A7E510D(__this, L_3, ((*(float*)((float*)(float*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 16))))), il2cpp_rgctx_method(method->klass->rgctx_data, 22));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
