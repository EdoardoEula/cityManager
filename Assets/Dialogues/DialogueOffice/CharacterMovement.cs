...
public class CharacterMovement : MonoBehaviour
{
    ...
    void HandleTurns()
    {
        ...
        if (currentWaypoint == 11) // Waypoint12 is at index 11 (0-based)
        {
        ...
        else if (currentWaypoint == 25) // Waypoint21 is at index 20 (0-based)
        {
            // Turn right when reaching Waypoint21
            transform.rotation = Quaternion.Euler(0f, -10f, 0f);
        }
        else if (currentWaypoint == 26) // Waypoint27 is at index 26 (0-based)
        {
        ...
        else if (currentWaypoint == 27) // Waypoint38 is at index 37 (0-based)
        {
            ...
            transform.rotation = Quaternion.Euler(0f, -25f, 0f); // Reset rotation to face forward

        }
        else if (currentWaypoint == 29) // Waypoint38 is at index 37 (0-based)
        {
            // Turn right when reaching Waypoint38
            transform.rotation = Quaternion.Euler(0f, -40f, 0f); // Reset rotation to face forward

        }
        else if (currentWaypoint == 30) // Waypoint38 is at index 37 (0-based)
        {
            // Turn right when reaching Waypoint38
            transform.rotation = Quaternion.Euler(0f, -70f, 0f); // Reset rotation to face forward

        }
        else if (currentWaypoint == 31) // Waypoint38 is at index 37 (0-based)
        {
            // Turn right when reaching Waypoint38
            transform.rotation = Quaternion.Euler(0f, -80f, 0f); // Reset rotation to face forward

        }
        else if (currentWaypoint == 36) // Waypoint38 is at index 37 (0-based)
        {
            // Turn right when reaching Waypoint38
            transform.rotation = Quaternion.Euler(0f, 30f, 0f); // Reset rotation to face forward

        }
        else if (currentWaypoint == 37) // Waypoint38 is at index 37 (0-based)
        {
            // Turn right when reaching Waypoint38
            transform.rotation = Quaternion.Euler(0f, 60f, 0f); // Reset rotation to face forward
        ...
        {
            // Turn right when reaching Waypoint45
            transform.rotation = Quaternion.Euler(0f, 190f, 0f); // Reset rotation to face forward
        }
        else if (currentWaypoint == 50)
        {
            // Turn right when reaching Waypoint50
            transform.rotation = Quaternion.Euler(0f, 210f, 0f); // Reset rotation to face forward
        }

        else if (currentWaypoint == waypoints.Length - 1)
        {
            // Reset to the first waypoint to restart the path
            currentWaypoint = 0;
        }
    ...
    public void CallCharacteruffici()
    {
    ...
    IEnumerator RunToTarget()
    {
        ...
        FindObjectOfType<CharacterInteraction>().StartDialogueAndEnableCanvas();
